...
type LiveRunConfig struct {
	...
	// ContextWindowCompression enables the Live API sliding-window compression
	// so audio sessions are not hard-terminated at ~15 minutes.
	// quran-agent patch: not present upstream (v1.4.0).
